...
[Click here for Colombia Extraction and Upload Overview Video](https://conservation.sharepoint.com/:v:/r/sites/PPC-GlobalPortfolioTeam/Monitoring%20%20Evaluations/02.%20Monitoring%20Management/Matteo%20Ramina%202025/Deliverable%201/colombia_data_pipeline_walkthrough.mp4?csf=1&web=1&e=oEEcyd "Colombia Extraction and Upload Overview")
...
dataset to the corresponding fields in the main Kobo form. It is used to 
...
* The script assumes that key column names in the Excel data will remain 
consistent across different rounds of data collection. This is because the 
renaming of these columns is hardcoded at the beginning of the script, under 
the `# Rename columns in colombia_data_mod` section. To make future 
modifications easier, any elements you might need to change, such as DBH column 
names or file names, are highlighted with a `# CHANGE HERE` indicator on their 
respective lines.
