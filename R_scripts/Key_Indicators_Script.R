...
Ntrees_regen_plot=aggregate(ind_data_regen$Tree_per_sq_30m, list("size_class"=ind_data_regen$size_class,
...
Ntrees_regen_site=aggregate(ind_data_regen$Tree_per_sq_30m, list("size_class"=ind_data_regen$size_class,
                                                                 "Tree_type"=ind_data_regen$Tree_type,
                                                                 "Species"=ind_data_regen$Species,
                                                                 "Timeframe"=ind_data_regen$main_data.Timeframe,
                                                                 "Site_ID"=ind_data_regen$main_data.Site_ID), sum)
...
#Number of regeneratin trees by plot
Ntrees_natregen_plot=aggregate(ind_data_natregen$Tree_per_sq_30m, list("size_class"=ind_data_natregen$size_class,
...
#Number of regenerating trees by site
Ntrees_natregen_site=aggregate(ind_data_natregen$Tree_per_sq_30m, list("size_class"=ind_data_natregen$size_class,
                                                                 "Tree_type"=ind_data_natregen$Tree_type,
                                                                 "Species"=ind_data_natregen$Species,
                                                                 "Timeframe"=ind_data_natregen$main_data.Timeframe,
                                                                 "Site_ID"=ind_data_natregen$main_data.Site_ID), sum)
